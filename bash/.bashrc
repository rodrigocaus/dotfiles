...
export CLOUDSDK_AUTH_CREDENTIAL_FILE_FOR_ADC="~/.config/gcloud/legacy_credentials/$(gcloud config configurations list --filter='is_active=true' --format='value(ACCOUNT)')/adc.json"
